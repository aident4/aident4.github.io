...
function createCollectable(type, x, y, gravity = 0, bounce = 1) {
  if (type !== "") {
    var image = document.createElement("img"); // this is not necessary; we could simply make a single element for each collectable type in the HTML instead
